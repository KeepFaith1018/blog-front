<template>
  ...
  >
    ...
    ></path>
    <path
      d="M779.1 489.7H534.3V155.8c0-12.3-10-22.3-22.3-22.3s-22.3 10-22.3 22.3V512c0 12.3 10 22.3 22.3 22.3h267.1c12.3 0 22.3-10 22.3-22.3s-10-22.3-22.3-22.3z"
      fill="var(--color-text-muted)"
      p-id="6423"
    ></path>
  </svg>
